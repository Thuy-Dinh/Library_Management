...
export default function SearchPage() {
  ...
  const [currentPage, setCurrentPage] = useState(1);
    ...
    // Tính index đầu và cuối của dữ liệu hiển thị trong trang hiện tại
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSearchResults(data);  // lưu kết quả riêng
    } catch (error) {
            ...
            <div className="search-left">
                <form className="search-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-grid">
                        <div className="form-group">
                            ...
                            <input type="text" id="title" name="title" placeholder="Tiêu đề" value={form.title} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label htmlFor="publisher">Nhà xuất bản:</label>
                            <input type="text" id="publisher" name="publisher" placeholder="Nhà xuất bản" value={form.publisher} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label htmlFor="author">Tác giả:</label>
                            <input type="text" id="author" name="author" placeholder="Tác giả" value={form.author} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label htmlFor="keyword">Từ khóa:</label>
                            <input type="text" id="keyword" name="keyword" placeholder="Từ khóa" value={form.keyword} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label htmlFor="language">Ngôn ngữ:</label>
                            <input type="text" id="language" name="language" placeholder="Ngôn ngữ" value={form.language} onChange={handleChange} />
                        </div>

                        <div className="form-group">
                            <label htmlFor="year">Năm xuất bản:</label>
                            <input type="text" id="year" name="year" placeholder="Năm xuất bản" value={form.year} onChange={handleChange} />
                        </div>
                    </div>
                ...
                <div className="search-result-2">
                    ...
                    <>
                        ...
                        <div key={index} className="book-detail book-detail-1" style={{width: 800}}>
